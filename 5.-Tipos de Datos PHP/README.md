...
<details>  <summary><h3> ¿Qué hace este programa? 🤔</h3> </summary>
  <p>
    En este código PHP podemos obervar el uso de variables
    y como php no es un lenguaje tipificado como C#,
    por lo que no es necesario declarar el tipo de dato
    de la variable.
    <p></p>
    Solo utilizamos "$", seguido del nombre
    de la variable.
  </p>

  <p>
    Para concatenar variables en PHP se utiliza el operador
    "." (punto), el cual se utiliza para concatenar cadenas
    o strings.
  </p>
...
//Variables
$Edad=32;               //Entero
$Nombre="Lechu.Dev";     //String
$Altura=1.63;           //Flotanto o decimal
$Programador=TRUE;      //Booleano

//Concatenación con "."
echo "El Nombre es -> ".$Nombre."<br>Tiene "
    .$Edad."Años 👴,". "<br>Mide ".$Altura.
    "m. <br>Es programaor? ".$Programador;
