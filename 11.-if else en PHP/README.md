...
## Uso de if-else en PHP

En PHP, los condicionales if-else son estructuras de control que nos permiten ejecutar diferentes bloques de código dependiendo de si una condición es verdadera o falsa. Esto nos permite realizar acciones alternativas según el resultado de una evaluación.

### Funcionamiento

El código proporcionado es un ejemplo de uso de un condicional if-else en PHP para verificar si dos valores son iguales o diferentes.
...
2. **Comparación de Valores:**
   - Se verifica si el valor de `$valorA` es diferente al valor de `$valorB` utilizando un if.
   - Si la condición es verdadera, se ejecuta el primer bloque de código dentro del if, mostrando un mensaje indicando que los valores son diferentes.
   - Si la condición es falsa, se ejecuta el segundo bloque de código dentro del else, mostrando un mensaje indicando que los valores son iguales.
